...
set(MSG_I_FLAGS "-Iinterprocess_communication:/home/sdhoro/amr/AMR-workshops/src/interprocess_communication/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/sdhoro/amr/AMR-workshops/src/interprocess_communication/msg/Update.msg" NAME_WE)
add_custom_target(_interprocess_communication_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "interprocess_communication" "/home/sdhoro/amr/AMR-workshops/src/interprocess_communication/msg/Update.msg" ""
)
...
_generate_msg_cpp(interprocess_communication
  "/home/sdhoro/amr/AMR-workshops/src/interprocess_communication/msg/Update.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/interprocess_communication)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/interprocess_communication\")")
  # install generated code
  install(
