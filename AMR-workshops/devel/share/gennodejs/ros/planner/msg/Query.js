...
class Query {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('start')) {
        ...
        this.start = new nav_msgs.msg.Odometry();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = nav_msgs.msg.Odometry.serialize(obj.start, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.start = nav_msgs.msg.Odometry.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    let length = 0;
    length += nav_msgs.msg.Odometry.getMessageSize(object.start);
    return length + 56;
  }
  ...
  static md5sum() {
    ...
    return 'dd60275744a151ffbccc5aa37ab621a3';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.start !== undefined) {
      resolved.start = nav_msgs.msg.Odometry.Resolve(msg.start)
    }
    else {
      resolved.start = new nav_msgs.msg.Odometry()
    }
